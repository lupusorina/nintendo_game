...
#define GFX_MARS ((u16*)BG_GFX)
#define GFX_EARTH ((u16*)BG_GFX_SUB)
#define TYPE_MARS 0
#define TYPE_EARTH 1/*
...
#define BOMB_COLOR_2	0b1000000000011111
#define BRICK_COLOR_5 	0b1000000000111111
#define BRICK_COLOR_4 	0b1000000000111000
