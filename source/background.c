...
void mars_init_bg()
{
	...
	//BGCTRL[3] = BG_BMP_BASE(7) | BgSize_B8_256x256 ;
	//AFfine Matrix
	/*
    ...
    //Copy of the palette and the bitmap
		/*swiCopy(background_picBitmap, BG_BMP_RAM(7), background_picBitmapLen/2);
		swiCopy(background_picPal, BG_PALETTE, background_picPalLen/2);*/

		//BG_PALETTE[8] =  	0b0000000000000000;
